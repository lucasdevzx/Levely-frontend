...
const InfoCard = ({ title, value, description, icon, link }) => {
    if (link === false) {
        return (
            <div className={"flex flex-row min-w-full w-full max-w-full min-h-25 p-4 items-start bg-card-elevated-1 border " +
                "border-zinc-700/20 rounded-md justify-between box-border" }>
